...
export const DEFAULT_USERS: ManagedUser[] = [
  {
    ...
    profile: {
      ...
      gscholarSkor: "2",
      bidangPenelitian: ["Data Science"],
      bidangPkm: ["Software Engineering"],
    },
  },
  { id: "USR-002", name: "Dr. Dosen Utama, M.Sc.", email: "dosen@example.com", roleKeys: ["dosen", "halaman-dosen"], fakultas: "Fakultas Teknologi", prodi: "Teknik Informatika", nidn: "0312098901", status: "active" },
  { id: "USR-003", name: "Prof. Reviewer Utama, Ph.D.", email: "reviewer@example.com", roleKeys: ["reviewer", "reviewer-hibah"], fakultas: "Fakultas Teknologi", prodi: "Teknik Informatika", nidn: "0312098902", status: "active" },
  { id: "USR-004", name: "User Demo", email: "user@example.com", roleKeys: ["halaman-umum"], fakultas: "-", prodi: "-", nidn: "000000003", status: "active" },
];
